    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='product.orderproduct')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='product.product')),
            ],
            options={
                'verbose_name': 'order product item',
                'verbose_name_plural': 'order product items',
            },
        ),
        migrations.AddField(
            model_name='orderproduct',
            name='products',
            field=models.ManyToManyField(related_name='order_products', through='product.OrderProductItem', to='product.product'),
        ),
        migrations.AddField(
            model_name='orderproduct',
            name='region',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_products', to='product.region'),
        ),
        migrations.AddField(
            model_name='orderproduct',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_products', to='product.anonymoususer'),
        ),
        migrations.AddField(
            model_name='city',
            name='region',
